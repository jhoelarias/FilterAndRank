...
namespace FilterAndRank.Tests
{
    public class RankingTests
    {
        ...
        [Category("Custom")]
        [Category("requirement-filterByCountry")]
        public void TestPersonsAreFilteredByTwoCountries()
        {
            var people = new List<Person>
            {
                    new Person(1, "Santiago"),
                    new Person(2, "Adena"),
                    new Person(3, "Linda"),
                    new Person(4, "Marisma"),
                    new Person(5, "Jhoel"),
                    new Person(6, "Andrea"),
            };
            ...
            var rankingData = new List<CountryRanking>
            {
                    new CountryRanking(1, "Aruba", 1),
                    new CountryRanking(2, "Zimbabwe", 1),
                    new CountryRanking(3, "Aruba", 2),
                    new CountryRanking(4, "Zimbabwe", 2),
                    new CountryRanking(5, "Zimbabwe", 3),
                    new CountryRanking(6, "Aruba", 3),
            };
            ...
            var expectedResults = new List<RankedResult>()
            {
                    ...
                    new RankedResult(6, 3),
            };

            var actualResults = FilterByCountryWithRank(
                    people,
                    rankingData,
                    new List<string> { "Zimbabwe", "Aruba" },
                    1, int.MaxValue,
                    int.MaxValue
            );
        ...
        [Category("Custom")]
        [Category("requirement-filterByCountry")]
        public void TestPersonsAreFilteredByTwoCountriesAndLimit()
        {
            var people = new List<Person>
            {
                    new Person(1, "Santiago"),
